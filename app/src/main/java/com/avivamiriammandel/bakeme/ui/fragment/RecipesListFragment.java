...
public class RecipesListFragment extends Fragment {
    ...
    private LifecycleOwner lifecycleOwner = RecipesListFragment.this;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            context = RecipesListFragment.this.getContext();
            ...
            adapter.setOnItemClickListener(new RecipeAdapter.onItemClickListener() {
                ...
                public void onItemClick(int position) {
                    ...
                    Recipe extraRecipe = recipes.get(position);

                    intent.putExtra(getString(R.string.recipe_bundle), extraRecipe);
